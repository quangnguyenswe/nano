...
const DISCORD_REDIRECT_AT = "discordRedirectAt";
const DISCORD_LAST_PAGE = "discordLastPage";
...
export default function DiscordButton(props: DiscordButtonProps) {
  ...
  const handleClick = async () => {
    ...
    if (!["/login", "/signup"].includes(window.location.pathname)) {
      ...
      localStorage.setItem(DISCORD_REDIRECT_AT, Date.now().toString());
      localStorage.setItem(DISCORD_LAST_PAGE, pagePath);
    }
  };
